  ...
  return (
    ...
    >
      <div css={rulesContainer}>
        <div className="intro">Aviator is a new generation of iGaming entertainment. You can win many times more, in seconds! Aviator is built on a provably fair system, which is currently the only real guarantee of honesty in the gambling industry.</div>
        <div className="error">Read more about provably fair system</div>
        <h1>HOW TO PLAY</h1>
        <div css={mediaContainer}>
          <iframe _ngcontent-ggc-c37="" frameBorder="0"
            allow="accelerometer; encrypted-media; gyroscope; picture-in-picture"
            className="embed-responsive-item"
            src="https://www.youtube.com/embed/PZejs3XDCSY?playsinline=1"></iframe>
        </div>
