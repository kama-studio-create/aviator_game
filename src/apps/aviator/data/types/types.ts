 ...
 *
 * Available Action:
 *  In this state, no actions are available to the user. The user will automatically be moved to the GAME_STATE_IN_PROGRESS state once the window elapses
 */
...
export type PlayMap = Record<number, Record<number, IPlay>>;
