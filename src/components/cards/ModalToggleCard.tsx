...
export const ModalToggleCard: FC<props> = ({handleSwitchChange, handleInputChange, title, inputValue,switchValue}) => {
  return (
    <div css={styles}>
      <div style={{justifyContent: 'space-between'}} css={rowStyles} >
        ...
        <div style={{justifyContent: 'flex-end'}} css={rowStyles}>
          ...
          <NumberInputWithButtons disabled={!switchValue} value={inputValue} onChange={handleInputChange}/>
        </div>
      </div>
    </div>
  )
