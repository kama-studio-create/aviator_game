...
export const MenuSettingsCard: FC = () => {
  ...
  const setAnimationEnabled = usePreferenceStore(state => state.setAnimationEnabled);
  ...
  return (
    <div css={cardStyles}>
      <MenuItemCard title={SOUND} icon={iconSound} handleChange={handleSound} value={isSoundEnabled} />
      <MenuItemCard title={MUSIC} icon={iconMusic} handleChange={handleMusic} value={isMusicEnabled} />
      <MenuItemCard title={ANIMATION} icon={iconAnimation} handleChange={handleAnimation} value={isAnimationEnabled} />
    </div>
  )
}