  ...
  return (
    <div css={modalStyles}>
      ...
      <div css={bodyStyles}>
        <div style={{ gap: 8 }} css={rowStyles}>
          ...
          <div>
            ...
            <p>
              Above seeds combined and converted to SHA512 Hash. This is your
              game result
            </p>
          </div>
        </div>
      ...
      <div style={{ textAlign: "center", paddingBlock: 0 }} css={bodyStyles}>
        <p>Hex:</p>
        <div css={selectContainer}>272c759cfc8dd42c7759b5fa5d</div>
      </div>
      <div style={{ textAlign: "center", paddingBlock: 0 }} css={bodyStyles}>
        <p>Decimal:</p>
        <div css={selectContainer}>672228827272772728</div>
      </div>
      <div style={{ textAlign: "center", paddingBlock: 0 }} css={bodyStyles}>
        <p>Result:</p>
        <div css={selectContainer}>23.01x</div>
      </div>
