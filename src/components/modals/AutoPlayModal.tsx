			...
			{isOpen && <div css={overlay}>
				<div css={container}>
					<div css={header}>
						...
						<button css={closeButton} onClick={closeModal}><img src={iconClose} alt='close'/></button>
					</div>
					<div css={body}>
						<div css={bodyCard}>
								...
								{roundOptions.map((option) => (
									<PillButton
										style={{
											...
											fontSize: 12,
											paddingBlock: 8,
											backgroundColor: numberOfRounds === option.value ? LIGHT_GRAY_COLOR : DARK_GRAY_COLOR,
											fontWeight: 400,
											color: numberOfRounds === option.value ? WHITE_COLOR : LIGHT_GRAY_COLOR,
					...
					<div css={footer}>
						<PillButton
							style={{paddingInline: 16, fontSize: 10, paddingBlock: 8, fontWeight: 400, background: PRIMARY_COLOR}}
							variant='error'
							size='sm'
							onClick={reset}>
							Reset
