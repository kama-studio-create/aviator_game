...
import {ERROR, NOTIFICATION_VISIBILITY, TNotificationState} from "../common/constants.ts";
...
const NotificationItem: FC<NotificationProps> = ({header, message, type, onClose}) => {
  ...
  return (
    <div style={{ backgroundColor: type === ERROR ? ERROR_COLOR: SUCCESS_COLOR}} css={notificationsStyles}>
      <div>
        <h1>{header}</h1>
        <p>{message}</p>
      </div>
