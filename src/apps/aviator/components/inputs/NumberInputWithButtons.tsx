...
export const NumberInputWithButtons: FC<props> = ({value, onValueChange, disabled, ...props}) => {
	...
	return (
		<div css={row} {...props}>
			...
			<NumberInput disabled={disabled} value={value} name="amount" handleChange={onValueChange}/>
